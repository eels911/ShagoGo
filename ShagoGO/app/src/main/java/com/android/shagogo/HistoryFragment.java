...
public class HistoryFragment extends Fragment {
    ...
    // общие настройки для всех баров
    private void BarSettings() {
        ...
        description.setText("");
        mBarChart.setDescription(description); // отключить текст описания
        mBarChart.getLegend().setEnabled(false); // отключить легенду
    ...
    // рассчитать элементы массива (только от 0 до 23)
    ...
    // обновить шаги, метры, время и скорость на экране
