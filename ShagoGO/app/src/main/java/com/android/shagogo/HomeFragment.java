...
public class HomeFragment extends Fragment {
    ...
    // преобразовать int в строку с пробелом между тысячами
    ...
    // конвертировать время в секундах в строку HH:MM:SS
    ...
    // создать новый intent и отправить его в service для передачи нового значения
    ...
    // создать график с сегодняшними шагами по часам
    private void GraphUpdate() {
        ...
        // установить некоторые настройки для графика
        mGraph.getLegend().setEnabled(false);
        final Description description = new Description();
        description.setText("");
        mGraph.setDescription(description);
        ...
        mGraph.invalidate(); // обновить данные
    }
