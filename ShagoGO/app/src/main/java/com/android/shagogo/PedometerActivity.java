...
public class PedometerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // инициализировать ToolBar для навигации
        // Handle Toolbar
        ...
        // инициализировать Navigation Drawer
    ...
    protected void onPause() {
        super.onPause();
        // скрыть диалоговое окно, если оно открыто
    ...
    // Показать диалоговое окно для подтверждения удаления истории
